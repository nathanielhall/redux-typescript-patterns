...
export const Actions = {
  /**  FETCH TODO ITEMS  */
  fetchTodoItems: () =>
    createAction(FETCH_ITEMS, {
      meta: {
        url: url,
        method: RequestMethod.GET
      }
    }),
  fetchTodoItemsOnSuccess: (response: ITodo[]) =>
    createAction(FETCH_ITEMS_ONSUCCESS, response),
  fetchTodoItemsOnError: (error: string) =>
    createAction(FETCH_ITEMS_ONERROR, error),

  /** DELETE TODO ITEMS  */
  deleteTodoItems: () =>
    createAction(DELETE_ITEMS, {
      meta: {
        url: url,
        method: RequestMethod.DELETE
      }
    }),
  deleteTodoItemsOnSuccess: (response: ITodo[]) =>
    createAction(DELETE_ITEMS_ONSUCCESS, response),
  deleteTodoItemsOnError: (error: string) =>
    createAction(DELETE_ITEMS_ONERROR, error),
  ...
  addTodoOnSuccess: (response: ITodo) =>
    createAction(ADD_TODO_ONSUCCESS, response),
  addTodoOnError: (error: string) => createAction(ADD_TODO_ONERROR, error),
  ...
  deleteTodoOnSuccess: (response: ITodo) =>
    createAction(DELETE_TODO_ONSUCCESS, response),
  deleteTodoOnError: (error: string) =>
    createAction(DELETE_TODO_ONERROR, error),

  /**  SET  */
  setTodo: (todo: ITodo) => createAction(SET_ADDED_TODO, {data: todo}),
  setTodoItems: (todoItems: ITodo[]) =>
    createAction(SET_FETCHED_ITEMS, {data: todoItems}),
  setDeletedTodo: (removedId: number) =>
    createAction(SET_DELETED_TODO, {id: removedId}),
